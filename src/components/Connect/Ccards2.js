...
{/* categories starts here...   */}
        ...
        <div className="menuitems justify-evenly" style={{color: 'rgb(108,93,211)'}}>
  <a href="#"  className="btn btn-primary buttons">Games</a>
  <a href="#"  className="btn btn-primary buttons">IRL</a>
  <a href="#"  className="btn btn-primary buttons">Esports</a>
  <a href="#"  className="btn btn-primary buttons">Music</a>
  <a href="#"  className="btn btn-primary buttons">Creative</a>
</div>
